Feature: AOW page template
  ...
  Scenario: Content Author can create page using AOW page template
    ...
    |Sub repeater,Items         |Heading          |input         |150           |true      |            |
    |Sub repeater,Items         |Heading target   |input         |              |true      |            |
    |Sub repeater,Items         |Body             |textarea      |350           |true      |            |
    |Sub repeater,Items         |Image            |image         |              |true      |            |
    |Sub Content Multiple,Content Area Content Block With 3 Paras         |Heading               |input             |50              |true      |            |
    |Sub Content Multiple,Content Area Content Block With 3 Paras         |Paragraph 1           |textarea         |450              |true      |            |
    |Sub Content Multiple,Content Area Content Block With 3 Paras         |Paragraph 2           |textarea         |450              |true      |            |
    |Sub Content Multiple,Content Area Content Block With 3 Paras         |Paragraph 3           |textarea         |450              |true      |            |
    |Listing                    |Heading            |input      |50           |true      |            |
    |Listing,Items              |Item               |input      |50           |true      |            |
    #And I save the page
